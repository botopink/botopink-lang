...
- `../../comptime/runtime/persistent_erl.zig` — `beam_file.assemble` output is what its cmd 4 loads (`evalBeamWithArg`); its inline test assembles `main(X) -> X.` with this model.
