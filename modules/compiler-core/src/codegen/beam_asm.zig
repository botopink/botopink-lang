...
const Emitter = struct {
    ...
    /// `Array.at`, a negative index counting from the end (decision 138).
    ...
    /// (decision 138): `J = I + length(L)`, and `lists:nth(J + 1, L)` when
    ...
    fn ensureAtHelper(self: *Emitter) anyerror![]const u8 {
        ...
        // A negative index counts from the end (decision 138): J = I + length.
