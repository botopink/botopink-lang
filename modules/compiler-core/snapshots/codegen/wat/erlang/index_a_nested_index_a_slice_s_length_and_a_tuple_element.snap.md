...
main() ->
    ...
    '__bp_print'(['__bp_len'((fun(__L, __I) -> __N = length(__L), __J = case __I < 0 of true -> __I + __N; false -> __I end, case ((__J >= 0) andalso (__J < __N)) of true -> lists:nth(__J + 1, __L); false -> undefined end end)(Rows, 0), length)]),
    Xs = [10, 20, 30],
