...
{function, choose, 1, 3}.
  {label, 2}.
    ...
    {func_info, {atom, test@main}, {atom, choose}, 1}.
  {label, 3}.
    {allocate, 1, 1}.
    {init_yregs, {list, [{y, 0}]}}.
    {move, {x, 0}, {y, 0}}.
    ...
    {test_heap, 3, 0}.
    {put_tuple2, {x, 0}, {list, [{atom, test@main@@R}, {integer, 7}]}}.
    {deallocate, 1}.
    return.
  {label, 10}.
...
{function, main, 0, 5}.
  ...
  {label, 5}.
    ...
    {jump, {f, 13}}.
  {label, 11}.
    {test, is_tagged_tuple, {f, 12}, [{x, 0}, 2, {atom, test@main@@R}]}.
...
{function, '__bp_format', 1, 6}.
  ...
  {label, 6}.
    ...
    {call_ext, 2, {extfunc, erlang, element, 2}}.
    {test_heap, 5, 1}.
    {put_tuple2, {x, 0}, {list, [{literal, <<"kind">>}, {x, 0}]}}.
