...
{function, main, 0, 9}.
  ...
  {label, 9}.
    ...
    {move, {y, 1}, {x, 0}}.
    {call, 2, {f, 7}}.
    {test, is_eq_exact, {f, 53}, [{x, 0}, {atom, undefined}]}.
    {move, {atom, true}, {x, 0}}.
    {jump, {f, 54}}.
  {label, 53}.
    {move, {atom, false}, {x, 0}}.
...
{function, '__bp_tagged', 2, 37}.
  ...
  {label, 37}.
    ...
    {move, {x, 1}, {y, 2}}.
    {test, is_nonempty_list, {f, 49}, [{x, 2}]}.
    {move, {y, 2}, {x, 0}}.
...
{function, '__bp_render', 1, 39}.
  ...
  {label, 39}.
    ...
    {move, {y, 0}, {x, 1}}.
    {call_ext, 2, {extfunc, erlang, element, 2}}.
    {test, is_eq_exact, {f, 51}, [{x, 0}, {atom, text}]}.
    {move, {integer, 2}, {x, 0}}.
    {move, {y, 0}, {x, 1}}.
...
{function, '-bp_at-', 2, 56}.
  ...
  {label, 56}.
    ...
    {move, {x, 0}, {y, 1}}.
    {move, {x, 1}, {y, 0}}.
    {test, is_ge, {f, 57}, [{y, 0}, {integer, 0}]}.
    {move, {y, 1}, {x, 0}}.
    {call_ext, 1, {extfunc, erlang, length, 1}}.
    {test, is_lt, {f, 57}, [{y, 0}, {x, 0}]}.
    {gc_bif, '+', {f, 0}, 0, [{y, 0}, {integer, 1}], {x, 0}}.
    {move, {y, 1}, {x, 1}}.
