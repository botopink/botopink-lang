...
{function, main, 0, 3}.
  ...
  {label, 45}.
    ...
    {put_tuple2, {x, 0}, {list, [{float, 1.5}, {x, 0}]}}.
    {move, {x, 0}, {y, 12}}.
    {test, is_eq_exact, {f, 46}, [{y, 10}, {y, 11}]}.
    {move, {atom, true}, {x, 0}}.
    {jump, {f, 47}}.
  {label, 46}.
    {move, {atom, false}, {x, 0}}.
  {label, 47}.
    ...
    {put_list, {x, 0}, nil, {x, 0}}.
    {call, 1, {f, 11}}.
    {test, is_eq_exact, {f, 48}, [{y, 10}, {y, 12}]}.
    {move, {atom, true}, {x, 0}}.
    {jump, {f, 49}}.
  {label, 48}.
    {move, {atom, false}, {x, 0}}.
