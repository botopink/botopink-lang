...
{function, main, 0, 3}.
  ...
  {label, 3}.
    ...
    {init_yregs, {list, [{y, 0}]}}.
    {test_heap, 3, 0}.
    {put_tuple2, {x, 0}, {list, [{atom, test@main@@Contador}, {integer, 5}]}}.
    {move, {x, 0}, {y, 0}}.
    {move, {y, 0}, {x, 0}}.
    {call_ext, 1, {extfunc, test@main@@Contador, atual, 1}}.
    {test_heap, 2, 1}.
...
----- BEAM ASSEMBLY -- test@main@@Contador.S
```erlang
{module, test@main@@Contador}.
{exports, [{atual, 1}, {'__bp_get', 2}, {'__bp_format', 1}]}.
{attributes, []}.
{labels, 10}.

{function, atual, 1, 3}.
  {label, 2}.
    {line, [{location, "test@main@@Contador.erl", 1}]}.
    {func_info, {atom, test@main@@Contador}, {atom, atual}, 1}.
  {label, 3}.
    {allocate, 1, 1}.
    {init_yregs, {list, [{y, 0}]}}.
    {move, {x, 0}, {y, 0}}.
    {move, {y, 0}, {x, 0}}.
    {test, is_tagged_tuple, {f, 4}, [{x, 0}, 2, {atom, test@main@@Contador}]}.
...
{function, '__bp_get', 2, 6}.
  {label, 5}.
    {line, [{location, "test@main@@Contador.erl", 2}]}.
    {func_info, {atom, test@main@@Contador}, {atom, '__bp_get'}, 2}.
  {label, 6}.
    {test, is_eq_exact, {f, 7}, [{x, 1}, {atom, n}]}.
    {move, {x, 0}, {x, 1}}.
    {move, {integer, 2}, {x, 0}}.
...
{function, '__bp_format', 1, 9}.
  {label, 8}.
    {line, [{location, "test@main@@Contador.erl", 2}]}.
    {func_info, {atom, test@main@@Contador}, {atom, '__bp_format'}, 1}.
  {label, 9}.
    {allocate, 2, 1}.
    {init_yregs, {list, [{y, 0}, {y, 1}]}}.
    {move, {x, 0}, {y, 0}}.
    ...
    {test_heap, 4, 1}.
    {put_tuple2, {x, 0}, {list, [{atom, record}, {literal, <<"Contador">>}, {y, 1}]}}.
    {deallocate, 2}.
    return.
```
