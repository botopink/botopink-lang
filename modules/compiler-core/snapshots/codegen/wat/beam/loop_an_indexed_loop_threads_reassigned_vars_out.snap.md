...
{function, '__bp_index', 2, 27}.
  {label, 26}.
    {line, [{location, "test@main.erl", 3}]}.
    {func_info, {atom, test@main}, {atom, '__bp_index'}, 2}.
  {label, 27}.
    {allocate, 2, 2}.
    {init_yregs, {list, [{y, 0}, {y, 1}]}}.
    {move, {x, 0}, {y, 0}}.
...
{function, '__bp_show', 2, 35}.
  ...
  {label, 35}.
    ...
    {move, {x, 1}, {y, 1}}.
    {move, {y, 0}, {x, 0}}.
    {test, is_binary, {f, 47}, [{x, 0}]}.
    {test, is_eq, {f, 46}, [{y, 1}, {atom, true}]}.
    {move, {y, 0}, {x, 0}}.
    {deallocate, 2}.
    return.
  {label, 46}.
  ...
  {label, 48}.
    ...
    {test, is_lt, {f, 49}, [{integer, 0}, {x, 0}]}.
    {move, {integer, 1}, {x, 0}}.
    {move, {y, 0}, {x, 1}}.
    {call_ext, 2, {extfunc, erlang, element, 2}}.
    {test, is_atom, {f, 49}, [{x, 0}]}.
    {test, is_ne_exact, {f, 49}, [{x, 0}, {atom, true}]}.
    {test, is_ne_exact, {f, 49}, [{x, 0}, {atom, false}]}.
  ...
  {label, 50}.
    {move, {y, 0}, {x, 0}}.
    {test, is_atom, {f, 52}, [{x, 0}]}.
    {test, is_ne_exact, {f, 52}, [{x, 0}, {atom, true}]}.
    {test, is_ne_exact, {f, 52}, [{x, 0}, {atom, false}]}.
...
{function, '__bp_tagged', 2, 41}.
  ...
  {label, 41}.
    ...
    {move, {x, 1}, {y, 2}}.
    {test, is_nonempty_list, {f, 54}, [{x, 2}]}.
    {move, {y, 2}, {x, 0}}.
...
{function, '__bp_render', 1, 43}.
  ...
  {label, 43}.
    ...
    {move, {y, 0}, {x, 1}}.
    {call_ext, 2, {extfunc, erlang, element, 2}}.
    {test, is_eq_exact, {f, 56}, [{x, 0}, {atom, text}]}.
    {move, {integer, 2}, {x, 0}}.
    {move, {y, 0}, {x, 1}}.
    {call_ext_last, 2, {extfunc, erlang, element, 2}, 2}.
  {label, 56}.
