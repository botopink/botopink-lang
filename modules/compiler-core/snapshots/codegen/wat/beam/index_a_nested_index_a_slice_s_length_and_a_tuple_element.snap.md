...
{function, '-bp_field-', 2, 49}.
  ...
  {label, 50}.
    ...
    {bif, element, {f, 53}, [{integer, 1}, {x, 0}], {x, 2}}.
    {test, is_atom, {f, 53}, [{x, 2}]}.
    {test_heap, 4, 3}.
  ...
  {label, 51}.
    {test, is_eq_exact, {f, 53}, [{x, 1}, {atom, length}]}.
...
{function, '__bp_tpl_0-t/2-fun-0-', 2, 60}.
  {label, 59}.
  ...
  {label, 72}.
    {move, {y, 4}, {x, 0}}.
    {test, is_eq_exact, {f, 74}, [{x, 0}, {atom, true}]}.
    {move, {y, 2}, {x, 0}}.
    {move, {y, 1}, {x, 1}}.
    {move, {integer, 1}, {x, 2}}.
  ...
  {label, 74}.
    {move, {y, 4}, {x, 0}}.
    {test, is_eq_exact, {f, 75}, [{x, 0}, {atom, false}]}.
    {move, {atom, undefined}, {x, 0}}.
    {deallocate, 7}.
    return.
  {label, 75}.
