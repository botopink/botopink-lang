...
{function, 'Pato_swim', 1, 3}.
  {label, 2}.
    {line, [{location, "test@pond.erl", 1}]}.
    {func_info, {atom, test@pond}, {atom, 'Pato_swim'}, 1}.
  {label, 3}.
    {allocate, 1, 1}.
    {init_yregs, {list, [{y, 0}]}}.
    {move, {x, 0}, {y, 0}}.
    {move, {y, 0}, {x, 0}}.
    {test, is_tagged_tuple, {f, 4}, [{x, 0}, 2, {atom, test@pond@@Pato}]}.
...
----- BEAM ASSEMBLY -- test@pond@@Pato.S
```erlang
...
{function, '__bp_get', 2, 3}.
  {label, 2}.
    {line, [{location, "test@pond@@Pato.erl", 1}]}.
    {func_info, {atom, test@pond@@Pato}, {atom, '__bp_get'}, 2}.
  {label, 3}.
    {test, is_eq_exact, {f, 4}, [{x, 1}, {atom, id}]}.
    {move, {x, 0}, {x, 1}}.
    {move, {integer, 2}, {x, 0}}.
...
{function, '__bp_format', 1, 6}.
  {label, 5}.
    {line, [{location, "test@pond@@Pato.erl", 1}]}.
    {func_info, {atom, test@pond@@Pato}, {atom, '__bp_format'}, 1}.
  {label, 6}.
    {allocate, 2, 1}.
    ...
    {test_heap, 4, 1}.
    {put_tuple2, {x, 0}, {list, [{atom, record}, {literal, <<"Pato">>}, {y, 1}]}}.
    {deallocate, 2}.
    return.
```
...
{function, main, 0, 3}.
  ...
  {label, 3}.
    ...
    {init_yregs, {list, [{y, 0}]}}.
    {test_heap, 3, 0}.
    {put_tuple2, {x, 0}, {list, [{atom, test@pond@@Pato}, {integer, 2}]}}.
    {move, {x, 0}, {y, 0}}.
    {move, {y, 0}, {x, 0}}.
    {call_ext, 1, {extfunc, test@pond, 'Pato_swim', 1}}.
    {test_heap, 2, 1}.
