...
{function, main, 0, 3}.
  ...
  {label, 3}.
    {allocate, 1, 0}.
    {init_yregs, {list, [{y, 0}]}}.
    {call_ext, 0, {extfunc, test@main@@Shape, unit, 0}}.
    {move, {x, 0}, {y, 0}}.
    {move, {y, 0}, {x, 0}}.
    {call_ext, 1, {extfunc, test@main@@Shape, area, 1}}.
    {test_heap, 2, 1}.
...
{function, unit, 0, 3}.
  {label, 2}.
    ...
    {func_info, {atom, test@main@@Shape}, {atom, unit}, 0}.
  {label, 3}.
    {allocate, 0, 0}.
    {test_heap, 3, 0}.
    {put_tuple2, {x, 0}, {list, [{atom, test@main@@Shape__v__square}, {integer, 1}]}}.
    {deallocate, 0}.
    return.
...
{function, area, 1, 5}.
  ...
  {label, 5}.
    ...
    {move, {x, 0}, {y, 0}}.
    {move, {y, 0}, {x, 0}}.
    {test, is_tagged_tuple, {f, 7}, [{x, 0}, 2, {atom, test@main@@Shape__v__circle}]}.
