...
{function, main, 0, 3}.
  ...
  {label, 3}.
    ...
    {move, {literal, <<"hi">>}, {x, 0}}.
    {test_heap, 3, 1}.
    {put_tuple2, {x, 0}, {list, [{atom, test@main@@Doc}, {x, 0}]}}.
    {move, {x, 0}, {y, 0}}.
    {move, {y, 0}, {x, 0}}.
    {call_ext, 1, {extfunc, test@main@@Doc, print, 1}}.
    {test_heap, 2, 1}.
...
----- BEAM ASSEMBLY -- test@main@@Doc.S
```erlang
{module, test@main@@Doc}.
{exports, [{print, 1}, {'__bp_get', 2}, {'__bp_format', 1}]}.
{attributes, []}.
{labels, 14}.

{function, print, 1, 3}.
  {label, 2}.
    {line, [{location, "test@main@@Doc.erl", 1}]}.
    {func_info, {atom, test@main@@Doc}, {atom, print}, 1}.
  {label, 3}.
    {allocate, 2, 1}.
    {init_yregs, {list, [{y, 0}, {y, 1}]}}.
    {move, {x, 0}, {y, 0}}.
    ...
    {move, {x, 0}, {y, 1}}.
    {move, {y, 0}, {x, 0}}.
    {test, is_tagged_tuple, {f, 4}, [{x, 0}, 2, {atom, test@main@@Doc}]}.
...
{function, '__bp_get', 2, 10}.
  {label, 9}.
    {line, [{location, "test@main@@Doc.erl", 2}]}.
    {func_info, {atom, test@main@@Doc}, {atom, '__bp_get'}, 2}.
  {label, 10}.
    {test, is_eq_exact, {f, 11}, [{x, 1}, {atom, title}]}.
    {move, {x, 0}, {x, 1}}.
    {move, {integer, 2}, {x, 0}}.
...
{function, '__bp_format', 1, 13}.
  {label, 12}.
    {line, [{location, "test@main@@Doc.erl", 2}]}.
    {func_info, {atom, test@main@@Doc}, {atom, '__bp_format'}, 1}.
  {label, 13}.
    {allocate, 2, 1}.
    {init_yregs, {list, [{y, 0}, {y, 1}]}}.
    {move, {x, 0}, {y, 0}}.
    ...
    {call_ext, 2, {extfunc, erlang, element, 2}}.
    {test_heap, 5, 1}.
    {put_tuple2, {x, 0}, {list, [{literal, <<"title">>}, {x, 0}]}}.
    {put_list, {x, 0}, {y, 1}, {y, 1}}.
    {test_heap, 4, 1}.
    {put_tuple2, {x, 0}, {list, [{atom, record}, {literal, <<"Doc">>}, {y, 1}]}}.
    {deallocate, 2}.
    return.

{function, '-bp_stringify-', 1, 6}.
  {label, 5}.
    {line, [{location, "test@main@@Doc.erl", 2}]}.
    {func_info, {atom, test@main@@Doc}, {atom, '-bp_stringify-'}, 1}.
  {label, 6}.
    {allocate, 0, 1}.
