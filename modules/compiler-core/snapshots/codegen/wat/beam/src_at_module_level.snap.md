...
{function, top, 0, 3}.
  ...
  {label, 3}.
    {allocate, 1, 0}.
    {init_yregs, {list, [{y, 0}]}}.
    {move, {literal, {test@main, top}}, {x, 0}}.
    {move, {atom, '$bp_unset'}, {x, 1}}.
    {call_ext, 2, {extfunc, persistent_term, get, 2}}.
    {test, is_eq_exact, {f, 10}, [{x, 0}, {atom, '$bp_unset'}]}.
...
{function, main, 0, 5}.
  ...
  {label, 12}.
    ...
    {move, {x, 0}, {y, 0}}.
    {call, 0, {f, 3}}.
    {test, is_tagged_tuple, {f, 13}, [{x, 0}, 5, {atom, test@main@@SourceLocation}]}.
  ...
  {label, 13}.
    ...
    {call, 1, {f, 15}}.
    {call, 0, {f, 3}}.
    {test, is_tagged_tuple, {f, 40}, [{x, 0}, 5, {atom, test@main@@SourceLocation}]}.
    {get_tuple_element, {x, 0}, 4, {x, 0}}.
  {label, 40}.
    {move, {x, 0}, {x, 1}}.
    {move, {literal, <<"">>}, {x, 0}}.
    {test, is_eq_exact, {f, 41}, [{x, 1}, {x, 0}]}.
    {move, {atom, true}, {x, 0}}.
    {jump, {f, 42}}.
  {label, 41}.
    {move, {atom, false}, {x, 0}}.
