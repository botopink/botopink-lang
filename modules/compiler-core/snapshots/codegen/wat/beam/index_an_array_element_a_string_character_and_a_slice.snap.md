...
{function, 'String_slice', 3, 60}.
  ...
  {label, 60}.
    ...
    {move, {x, 1}, {y, 1}}.
    {move, {x, 2}, {y, 2}}.
    {test, is_ne_exact, {f, 61}, [{y, 2}, {atom, undefined}]}.
    {move, {y, 0}, {x, 0}}.
    {move, {y, 2}, {x, 2}}.
    {move, {y, 1}, {x, 1}}.
    {call_last, 3, {f, 63}, 3}.
...
{function, '__bp_tpl_0-t/2-fun-0-', 2, 50}.
  {label, 49}.
  ...
  {label, 53}.
    {move, {y, 3}, {x, 0}}.
    {test, is_eq_exact, {f, 54}, [{x, 0}, {atom, false}]}.
    {move, {atom, false}, {y, 2}}.
    {jump, {f, 55}}.
  {label, 54}.
    {test_heap, 3, 0}.
