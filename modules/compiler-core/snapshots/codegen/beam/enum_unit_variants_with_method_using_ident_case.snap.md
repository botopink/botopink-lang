...
{function, name, 1, 3}.
  ...
  {label, 3}.
    ...
    {move, {x, 0}, {y, 0}}.
    {move, {y, 0}, {x, 0}}.
    {test, is_eq, {f, 5}, [{x, 0}, {atom, main__t__httpmethod__v__get}]}.
    {move, {literal, <<"GET">>}, {x, 0}}.
    {jump, {f, 4}}.
  {label, 5}.
    {test, is_eq, {f, 6}, [{x, 0}, {atom, main__t__httpmethod__v__post}]}.
    {move, {literal, <<"POST">>}, {x, 0}}.
    {jump, {f, 4}}.
  {label, 6}.
    {test, is_eq, {f, 7}, [{x, 0}, {atom, main__t__httpmethod__v__put}]}.
...
{function, '__bp_format', 1, 9}.
  {label, 8}.
    {line, [{location, "main__t__httpmethod.erl", 2}]}.
    {func_info, {atom, main__t__httpmethod}, {atom, '__bp_format'}, 1}.
  {label, 9}.
    {allocate, 2, 1}.
    {init_yregs, {list, [{y, 0}, {y, 1}]}}.
    {move, {x, 0}, {y, 0}}.
    {move, {y, 0}, {x, 0}}.
    {test, is_eq_exact, {f, 10}, [{x, 0}, {atom, main__t__httpmethod__v__get}]}.
    {test_heap, 4, 1}.
  ...
  {label, 10}.
    {move, {y, 0}, {x, 0}}.
    {test, is_eq_exact, {f, 11}, [{x, 0}, {atom, main__t__httpmethod__v__post}]}.
    {test_heap, 4, 1}.
  ...
  {label, 11}.
    {move, {y, 0}, {x, 0}}.
    {test, is_eq_exact, {f, 12}, [{x, 0}, {atom, main__t__httpmethod__v__put}]}.
    {test_heap, 4, 1}.
  ...
  {label, 12}.
    {move, {y, 0}, {x, 0}}.
    {test, is_eq_exact, {f, 13}, [{x, 0}, {atom, main__t__httpmethod__v__delete}]}.
    {test_heap, 4, 1}.
