...
```erlang
{module, main__t__box}.
{exports, [{total, 1}, {isBig, 1}, {doubled, 1}, {label, 1}]}.
{attributes, []}.
{labels, 19}.
...
{function, total, 1, 3}.
  ...
  {label, 3}.
    ...
    {get_map_elements, {f, 12}, {x, 0}, {list, [{atom, items}, {x, 0}]}}.
  {label, 12}.
    {move, {y, 1}, {x, 1}}.
    {move, {x, 0}, {x, 2}}.
    {test_heap, {alloc, [{words, 0}, {floats, 0}, {funs, 1}]}, 3}.
...
{function, isBig, 1, 5}.
  ...
  {label, 5}.
    ...
    {get_map_elements, {f, 13}, {x, 0}, {list, [{atom, items}, {x, 0}]}}.
  {label, 13}.
...
{function, doubled, 1, 7}.
  ...
  {label, 7}.
    ...
    {get_map_elements, {f, 16}, {x, 0}, {list, [{atom, items}, {x, 0}]}}.
  {label, 16}.
    {move, {x, 0}, {x, 1}}.
