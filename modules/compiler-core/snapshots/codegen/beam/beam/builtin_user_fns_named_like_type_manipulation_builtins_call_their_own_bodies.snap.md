...
{function, omit, 1, 5}.
  {label, 4}.
    ...
    {func_info, {atom, test@main}, {atom, omit}, 1}.
  {label, 5}.
    {allocate, 1, 1}.
    {init_yregs, {list, [{y, 0}]}}.
    {move, {x, 0}, {y, 0}}.
...
{function, partial, 1, 7}.
  {label, 6}.
    ...
    {func_info, {atom, test@main}, {atom, partial}, 1}.
  {label, 7}.
    {allocate, 1, 1}.
    {init_yregs, {list, [{y, 0}]}}.
    {move, {x, 0}, {y, 0}}.
...
{function, mergeRecords, 2, 9}.
  {label, 8}.
    ...
    {func_info, {atom, test@main}, {atom, mergeRecords}, 2}.
  {label, 9}.
    {allocate, 2, 2}.
...
{function, mapFields, 1, 11}.
  {label, 10}.
    ...
    {func_info, {atom, test@main}, {atom, mapFields}, 1}.
  {label, 11}.
    {allocate, 1, 1}.
    {init_yregs, {list, [{y, 0}]}}.
    {move, {x, 0}, {y, 0}}.
