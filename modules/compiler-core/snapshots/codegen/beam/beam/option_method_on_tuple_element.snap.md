...
{function, main, 0, 9}.
  ...
  {label, 9}.
    ...
    {move, {x, 0}, {y, 2}}.
    {move, {y, 2}, {x, 0}}.
    {test, is_eq, {f, 23}, [{x, 0}, {atom, undefined}]}.
    {move, {integer, -1}, {x, 0}}.
    {jump, {f, 24}}.
  {label, 23}.
  {label, 24}.
...
{function, '__bp_show', 2, 28}.
  ...
  {label, 28}.
    ...
    {move, {x, 1}, {y, 1}}.
    {move, {y, 0}, {x, 0}}.
    {test, is_binary, {f, 40}, [{x, 0}]}.
    {test, is_eq, {f, 39}, [{y, 1}, {atom, true}]}.
    {move, {y, 0}, {x, 0}}.
    {deallocate, 2}.
    return.
  {label, 39}.
...
{function, '__bp_tagged', 2, 34}.
  ...
  {label, 34}.
    ...
    {move, {x, 1}, {y, 2}}.
    {test, is_nonempty_list, {f, 47}, [{x, 2}]}.
    {move, {y, 2}, {x, 0}}.
...
{function, '__bp_render', 1, 36}.
  ...
  {label, 36}.
    ...
    {move, {y, 0}, {x, 1}}.
    {call_ext, 2, {extfunc, erlang, element, 2}}.
    {test, is_eq_exact, {f, 49}, [{x, 0}, {atom, text}]}.
    {move, {integer, 2}, {x, 0}}.
    {move, {y, 0}, {x, 1}}.
