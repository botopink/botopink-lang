...
{function, area, 1, 3}.
  {label, 2}.
    ...
    {func_info, {atom, test@main}, {atom, area}, 1}.
  {label, 3}.
    {allocate, 3, 1}.
...
{function, main, 0, 5}.
  ...
  {label, 5}.
    {allocate, 0, 0}.
    {test_heap, 3, 0}.
    {put_tuple2, {x, 0}, {list, [{atom, test@main@@Shape__v__circle}, {float, 2.0}]}}.
    {call, 1, {f, 3}}.
    {test_heap, 2, 1}.
    {put_list, {x, 0}, nil, {x, 0}}.
    {call, 1, {f, 14}}.
    {test_heap, 3, 0}.
    {put_tuple2, {x, 0}, {list, [{atom, test@main@@Shape__v__square}, {float, 3.0}]}}.
    {call, 1, {f, 3}}.
    {test_heap, 2, 1}.
    {put_list, {x, 0}, nil, {x, 0}}.
    {call, 1, {f, 14}}.
