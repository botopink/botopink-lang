...
{function, main, 0, 3}.
  ...
  {label, 3}.
    ...
    {init_yregs, {list, [{y, 0}]}}.
    {test_heap, 3, 0}.
    {put_tuple2, {x, 0}, {list, [{atom, test@main@@Probe}, {integer, 1}]}}.
    {call_ext, 1, {extfunc, test@main@@Probe, raw, 1}}.
    {test_heap, 2, 1}.
...
----- BEAM ASSEMBLY -- test@main@@Probe.S
```erlang
{module, test@main@@Probe}.
{exports, [{raw, 1}, {'__bp_get', 2}, {'__bp_format', 1}]}.
{attributes, []}.
{labels, 11}.

{function, raw, 1, 3}.
  {label, 2}.
    {line, [{location, "test@main@@Probe.erl", 1}]}.
    {func_info, {atom, test@main@@Probe}, {atom, raw}, 1}.
  {label, 3}.
    {allocate, 1, 1}.
    {init_yregs, {list, [{y, 0}]}}.
    {move, {x, 0}, {y, 0}}.
...
{function, '__bp_get', 2, 7}.
  {label, 6}.
    {line, [{location, "test@main@@Probe.erl", 2}]}.
    {func_info, {atom, test@main@@Probe}, {atom, '__bp_get'}, 2}.
  {label, 7}.
    {test, is_eq_exact, {f, 8}, [{x, 1}, {atom, n}]}.
    {move, {x, 0}, {x, 1}}.
    {move, {integer, 2}, {x, 0}}.
...
{function, '__bp_format', 1, 10}.
  {label, 9}.
    {line, [{location, "test@main@@Probe.erl", 2}]}.
    {func_info, {atom, test@main@@Probe}, {atom, '__bp_format'}, 1}.
  {label, 10}.
    {allocate, 2, 1}.
    {init_yregs, {list, [{y, 0}, {y, 1}]}}.
    {move, {x, 0}, {y, 0}}.
    ...
    {test_heap, 4, 1}.
    {put_tuple2, {x, 0}, {list, [{atom, record}, {literal, <<"Probe">>}, {y, 1}]}}.
    {deallocate, 2}.
    return.

{function, '__bp_tpl_0', 1, 5}.
  {label, 4}.
    {func_info, {atom, test@main@@Probe}, {atom, '__bp_tpl_0'}, 1}.
  {label, 5}.
    {allocate, 1, 1}.
    {init_yregs, {list, [{y, 0}]}}.
    {move, {x, 0}, {y, 0}}.
    {move, {integer, 2}, {x, 0}}.
    {move, {y, 0}, {x, 1}}.
    {call_ext_last, 2, {extfunc, erlang, element, 2}, 1}.
```
