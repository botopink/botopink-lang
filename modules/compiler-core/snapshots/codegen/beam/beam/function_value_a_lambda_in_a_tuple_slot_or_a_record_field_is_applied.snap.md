...
{function, mk, 0, 3}.
  {label, 2}.
    ...
    {func_info, {atom, test@main}, {atom, mk}, 0}.
  {label, 3}.
    {allocate, 2, 0}.
...
{function, main, 0, 5}.
  ...
  {label, 5}.
    ...
    {move, {x, 0}, {y, 2}}.
    {move, {y, 2}, {x, 0}}.
    {test, is_tagged_tuple, {f, 41}, [{x, 0}, 2, {atom, test@main@@Ops}]}.
...
{function, '-mk/0-fun-0-', 1, 11}.
  {label, 10}.
    {line, [{location, "test@main.erl", 2}]}.
    {func_info, {atom, test@main}, {atom, '-mk/0-fun-0-'}, 1}.
  {label, 11}.
    {allocate, 1, 1}.
    {init_yregs, {list, [{y, 0}]}}.
    {move, {x, 0}, {y, 0}}.
...
{function, '__bp_get', 2, 3}.
  {label, 2}.
    {line, [{location, "test@main@@Ops.erl", 1}]}.
    {func_info, {atom, test@main@@Ops}, {atom, '__bp_get'}, 2}.
  {label, 3}.
    {test, is_eq_exact, {f, 4}, [{x, 1}, {atom, step}]}.
    {move, {x, 0}, {x, 1}}.
    {move, {integer, 2}, {x, 0}}.
...
{function, '__bp_format', 1, 6}.
  {label, 5}.
    {line, [{location, "test@main@@Ops.erl", 1}]}.
    {func_info, {atom, test@main@@Ops}, {atom, '__bp_format'}, 1}.
  {label, 6}.
    {allocate, 2, 1}.
    {init_yregs, {list, [{y, 0}, {y, 1}]}}.
    {move, {x, 0}, {y, 0}}.
    ...
    {call_ext, 2, {extfunc, erlang, element, 2}}.
    {test_heap, 5, 1}.
    {put_tuple2, {x, 0}, {list, [{literal, <<"step">>}, {x, 0}]}}.
    {put_list, {x, 0}, {y, 1}, {y, 1}}.
    {test_heap, 4, 1}.
    {put_tuple2, {x, 0}, {list, [{atom, record}, {literal, <<"Ops">>}, {y, 1}]}}.
    {deallocate, 2}.
    return.
```
