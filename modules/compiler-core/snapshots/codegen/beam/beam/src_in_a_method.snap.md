...
{function, main, 0, 3}.
  ...
  {label, 3}.
    ...
    {test_heap, 3, 0}.
    {put_tuple2, {x, 0}, {list, [{atom, test@main@@Stub}, {integer, 1}]}}.
    {call_ext, 1, {extfunc, test@main@@Stub, where, 1}}.
    {move, {x, 0}, {y, 0}}.
    {move, nil, {x, 0}}.
    {move, {x, 0}, {y, 1}}.
    {move, {y, 0}, {x, 0}}.
    {test, is_tagged_tuple, {f, 8}, [{x, 0}, 5, {atom, test@main@@SourceLocation}]}.
  ...
  {label, 8}.
    ...
    {move, {x, 0}, {y, 1}}.
    {move, {y, 0}, {x, 0}}.
    {test, is_tagged_tuple, {f, 9}, [{x, 0}, 5, {atom, test@main@@SourceLocation}]}.
...
----- BEAM ASSEMBLY -- test@main@@Stub.S
```erlang
...
{function, where, 1, 3}.
  {label, 2}.
    {line, [{location, "test@main@@Stub.erl", 1}]}.
    {func_info, {atom, test@main@@Stub}, {atom, where}, 1}.
  {label, 3}.
    {allocate, 1, 1}.
    {init_yregs, {list, [{y, 0}]}}.
    {move, {x, 0}, {y, 0}}.
    ...
    {test_heap, 6, 2}.
    {put_tuple2, {x, 0}, {list, [{atom, test@main@@SourceLocation}, {x, 1}, {integer, 3}, {integer, 16}, {x, 0}]}}.
    {deallocate, 1}.
    return.

{function, '__bp_get', 2, 5}.
  {label, 4}.
    {line, [{location, "test@main@@Stub.erl", 2}]}.
    {func_info, {atom, test@main@@Stub}, {atom, '__bp_get'}, 2}.
  {label, 5}.
...
{function, '__bp_format', 1, 8}.
  {label, 7}.
    {line, [{location, "test@main@@Stub.erl", 2}]}.
    {func_info, {atom, test@main@@Stub}, {atom, '__bp_format'}, 1}.
  {label, 8}.
    {allocate, 2, 1}.
    {init_yregs, {list, [{y, 0}, {y, 1}]}}.
    {move, {x, 0}, {y, 0}}.
