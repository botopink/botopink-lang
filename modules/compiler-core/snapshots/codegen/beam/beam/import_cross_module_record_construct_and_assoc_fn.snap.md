...
{function, '__bp_format', 1, 8}.
  ...
  {label, 8}.
    ...
    {test_heap, 5, 1}.
    {put_tuple2, {x, 0}, {list, [{literal, <<"body">>}, {x, 0}]}}.
    {put_list, {x, 0}, {y, 1}, {y, 1}}.
    {test_heap, 4, 1}.
    {put_tuple2, {x, 0}, {list, [{atom, record}, {literal, <<"Response">>}, {y, 1}]}}.
    {deallocate, 2}.
    return.
```
...
{function, '__bp_get', 2, 3}.
  ...
  {label, 3}.
    ...
    {call_ext_only, 2, {extfunc, erlang, element, 2}}.
  {label, 4}.
    {test, is_eq_exact, {f, 5}, [{x, 1}, {atom, path}]}.
    {move, {x, 0}, {x, 1}}.
    {move, {integer, 3}, {x, 0}}.
    {call_ext_only, 2, {extfunc, erlang, element, 2}}.
  {label, 5}.
...
{function, '__bp_format', 1, 7}.
  ...
  {label, 7}.
    ...
    {put_list, {x, 0}, {y, 1}, {y, 1}}.
    {test_heap, 4, 1}.
    {put_tuple2, {x, 0}, {list, [{atom, record}, {literal, <<"App">>}, {y, 1}]}}.
    {deallocate, 2}.
    return.
```
...
{function, main, 0, 3}.
  ...
  {label, 8}.
    ...
    {move, {x, 0}, {y, 1}}.
    {move, {y, 1}, {x, 0}}.
    {test, is_tagged_tuple, {f, 35}, [{x, 0}, 3, {atom, test@http@@App}]}.
    {get_tuple_element, {x, 0}, 1, {x, 0}}.
  {label, 35}.
    {test_heap, 2, 1}.
    {put_list, {x, 0}, nil, {x, 0}}.
