...
{function, validate, 1, 3}.
  ...
  {label, 3}.
    ...
    {test_heap, 4, 1}.
    {put_tuple2, {x, 0}, {list, [{atom, main__t__apperror}, {integer, 400}, {x, 0}]}}.
...
----- BEAM ASSEMBLY -- main__t__apperror.S
```erlang
...
{function, '__bp_get', 2, 3}.
  {label, 2}.
    {line, [{location, "main__t__apperror.erl", 1}]}.
    {func_info, {atom, main__t__apperror}, {atom, '__bp_get'}, 2}.
  {label, 3}.
...
{function, '__bp_format', 1, 7}.
  {label, 6}.
    {line, [{location, "main__t__apperror.erl", 1}]}.
    {func_info, {atom, main__t__apperror}, {atom, '__bp_format'}, 1}.
  {label, 7}.
    {allocate, 2, 1}.
