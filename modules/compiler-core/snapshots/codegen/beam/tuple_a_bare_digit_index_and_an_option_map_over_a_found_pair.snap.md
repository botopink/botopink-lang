...
{function, main, 0, 9}.
  ...
  {label, 9}.
    ...
    {move, {y, 1}, {x, 0}}.
    {call, 2, {f, 7}}.
    {test, is_eq, {f, 37}, [{x, 0}, {atom, undefined}]}.
    {move, {atom, true}, {x, 0}}.
    {jump, {f, 38}}.
  {label, 37}.
    {move, {atom, false}, {x, 0}}.
...
{function, '-bp_at-', 2, 40}.
  ...
  {label, 40}.
    ...
    {move, {x, 0}, {y, 1}}.
    {move, {x, 1}, {y, 0}}.
    {test, is_ge, {f, 41}, [{y, 0}, {integer, 0}]}.
    {move, {y, 1}, {x, 0}}.
    {call_ext, 1, {extfunc, erlang, length, 1}}.
    {test, is_lt, {f, 41}, [{y, 0}, {x, 0}]}.
    {gc_bif, '+', {f, 0}, 0, [{y, 0}, {integer, 1}], {x, 0}}.
    {move, {y, 1}, {x, 1}}.
