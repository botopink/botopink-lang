...
{function, fromList, 1, 3}.
  {label, 2}.
    ...
    {func_info, {atom, test@main}, {atom, fromList}, 1}.
  {label, 3}.
    {allocate, 1, 1}.
    {init_yregs, {list, [{y, 0}]}}.
    {move, {x, 0}, {y, 0}}.
...
{function, toList, 1, 5}.
  {label, 4}.
    ...
    {func_info, {atom, test@main}, {atom, toList}, 1}.
  {label, 5}.
    {allocate, 2, 1}.
...
{function, '-fromList/1-fun-0-', 1, 13}.
  {label, 12}.
    {line, [{location, "test@main.erl", 2}]}.
    {func_info, {atom, test@main}, {atom, '-fromList/1-fun-0-'}, 1}.
  {label, 13}.
    {allocate, 1, 1}.
    {init_yregs, {list, [{y, 0}]}}.
    {move, {x, 0}, {y, 0}}.
...
{function, '-toList/1-fun-1-', 2, 15}.
  {label, 14}.
    {line, [{location, "test@main.erl", 3}]}.
    {func_info, {atom, test@main}, {atom, '-toList/1-fun-1-'}, 2}.
  {label, 15}.
    {allocate, 2, 2}.
    {init_yregs, {list, [{y, 0}, {y, 1}]}}.
    {move, {x, 0}, {y, 0}}.
