...
// read: per-call template (see annotation)
function read(name) { return (process.env[name] ?? null); }
exports.read = read;
...
// write: per-call template (see annotation)
function write(name, value) { return (process.env[name] = value); }
exports.write = write;

// Clear env var `name`. After this call, `read(name)` returns `null`.

// clear: per-call template (see annotation)
function clear(name) { return (delete process.env[name]); }
exports.clear = clear;
...
// args: per-call template (see annotation)
...
// vars: per-call template (see annotation)
function vars() { return (Object.entries(process.env)); }
exports.vars = vars;

// ── tests ────────────────────────────────────────────────────────────────────
```

----- TYPESCRIPT TYPEDEF -- std/io/env.d.ts
```typescript
export declare function read(name: string): string | null;


export declare function write(name: string, value: string): void;


export declare function clear(name: string): void;


export declare function args(): string[];


export declare function vars(): Array<[string, string]>;
