...
{function, main, 0, 3}.
  ...
  {label, 3}.
    ...
    {get_map_elements, {f, 41}, {x, 0}, {list, [{atom, length}, {x, 0}]}}.
  {label, 41}.
    {test_heap, 2, 1}.
    {put_list, {x, 0}, nil, {x, 0}}.
    {call, 1, {f, 9}}.
  ...
  {label, 47}.
    ...
    {get_map_elements, {f, 48}, {x, 0}, {list, [{atom, length}, {x, 0}]}}.
  {label, 48}.
    {test_heap, 2, 1}.
    {put_list, {x, 0}, nil, {x, 0}}.
    {call, 1, {f, 9}}.
    ...
    {get_map_elements, {f, 49}, {x, 0}, {list, [{atom, length}, {x, 0}]}}.
  {label, 49}.
    {test_heap, 2, 1}.
    {put_list, {x, 0}, nil, {x, 0}}.
    {call, 1, {f, 9}}.
...
{function, '-bp_at-', 2, 34}.
  ...
  {label, 34}.
    ...
    {move, {x, 0}, {y, 1}}.
    {move, {x, 1}, {y, 0}}.
    {test, is_ge, {f, 35}, [{y, 0}, {integer, 0}]}.
    {move, {y, 1}, {x, 0}}.
    {call_ext, 1, {extfunc, erlang, length, 1}}.
    {test, is_lt, {f, 35}, [{y, 0}, {x, 0}]}.
...
{function, '__bp_slice', 3, 43}.
  ...
  {label, 43}.
    ...
    {move, {x, 1}, {y, 1}}.
    {move, {x, 2}, {y, 2}}.
    {test, is_eq, {f, 44}, [{y, 2}, {atom, infinity}]}.
    {move, {y, 0}, {x, 0}}.
