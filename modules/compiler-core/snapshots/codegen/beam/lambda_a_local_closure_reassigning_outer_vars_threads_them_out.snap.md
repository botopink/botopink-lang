...
{function, render, 1, 3}.
  {label, 2}.
    ...
    {func_info, {atom, test@main}, {atom, render}, 1}.
  {label, 3}.
    {allocate, 5, 1}.
...
{function, '-render/1-fun-0-', 2, 11}.
  {label, 10}.
    {line, [{location, "test@main.erl", 2}]}.
    {func_info, {atom, test@main}, {atom, '-render/1-fun-0-'}, 2}.
  {label, 11}.
    {allocate, 5, 2}.
    {init_yregs, {list, [{y, 0}, {y, 1}, {y, 2}, {y, 3}, {y, 4}]}}.
    {move, {x, 0}, {y, 0}}.
...
{function, '-render/1-fun-1-', 3, 17}.
  {label, 16}.
    {line, [{location, "test@main.erl", 2}]}.
    {func_info, {atom, test@main}, {atom, '-render/1-fun-1-'}, 3}.
  {label, 17}.
    {allocate, 5, 3}.
    {init_yregs, {list, [{y, 0}, {y, 1}, {y, 2}, {y, 3}, {y, 4}]}}.
    {move, {x, 0}, {y, 0}}.
