...
{function, top, 0, 3}.
  {label, 2}.
    ...
    {func_info, {atom, main}, {atom, top}, 0}.
  {label, 3}.
    {allocate, 0, 0}.
    ...
    {move, {literal, <<"">>}, {x, 0}}.
    {test_heap, 6, 2}.
    {put_tuple2, {x, 0}, {list, [{atom, main__t__sourcelocation}, {x, 1}, {integer, 1}, {integer, 11}, {x, 0}]}}.
    {deallocate, 0}.
    return.
...
{function, main, 0, 5}.
  ...
  {label, 12}.
    ...
    {call, 1, {f, 14}}.
    {call, 0, {f, 3}}.
    {test, is_tagged_tuple, {f, 38}, [{x, 0}, 5, {atom, main__t__sourcelocation}]}.
