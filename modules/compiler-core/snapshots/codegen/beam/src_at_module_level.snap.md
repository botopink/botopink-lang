...
{function, top, 0, 3}.
  ...
  {label, 3}.
    ...
    {move, {x, 0}, {x, 1}}.
    {move, {literal, <<"">>}, {x, 0}}.
    {put_map_assoc, {f, 0}, {literal, #{}}, {x, 0}, 2, {list, [{atom, file}, {x, 1}, {atom, line}, {integer, 1}, {atom, column}, {integer, 11}, {atom, fnName}, {x, 0}]}}.
    {deallocate, 0}.
    return.
...
{function, main, 0, 5}.
  ...
  {label, 5}.
    ...
    {get_map_elements, {f, 10}, {x, 0}, {list, [{atom, column}, {x, 0}]}}.
  {label, 10}.
    {move, {y, 0}, {x, 1}}.
    {test_heap, 2, 2}.
    ...
    {get_map_elements, {f, 11}, {x, 0}, {list, [{atom, line}, {x, 0}]}}.
  {label, 11}.
    {move, {y, 0}, {x, 1}}.
    {test_heap, 2, 2}.
    {put_list, {x, 0}, {x, 1}, {x, 0}}.
    ...
    {get_map_elements, {f, 12}, {x, 0}, {list, [{atom, file}, {x, 0}]}}.
  {label, 12}.
    {move, {y, 0}, {x, 1}}.
    {test_heap, 2, 2}.
    {put_list, {x, 0}, {x, 1}, {x, 0}}.
    ...
    {get_map_elements, {f, 26}, {x, 0}, {list, [{atom, fnName}, {x, 0}]}}.
  {label, 26}.
    {move, {x, 0}, {x, 1}}.
    {move, {literal, <<"">>}, {x, 0}}.
    {test, is_eq, {f, 27}, [{x, 1}, {x, 0}]}.
    {move, {atom, true}, {x, 0}}.
    {jump, {f, 28}}.
  {label, 27}.
    {move, {atom, false}, {x, 0}}.
