...
{function, main, 0, 7}.
  ...
  {label, 7}.
    ...
    {put_list, {x, 0}, {x, 1}, {x, 0}}.
    {move, {x, 0}, {y, 3}}.
    {put_map_assoc, {f, 0}, {literal, #{}}, {x, 1}, 0, {list, [{atom, '__BpSelf'}, {y, 1}, {atom, '__BpA0'}, {y, 3}]}}.
    {move, {literal, <<"lists:zipwith(fun(__X, __Y) -> {__X, __Y} end, lists:sublist(__BpSelf, length(__BpA0)), lists:sublist(__BpA0, length(__BpSelf))).">>}, {x, 0}}.
    {call, 2, {f, 17}}.
    {test_heap, 2, 1}.
...
{function, '__bp_erl_eval', 2, 17}.
  ...
  {label, 17}.
    ...
    {test, is_tagged_tuple, {f, 18}, [{x, 0}, 3, {atom, ok}]}.
    ...
    {test, is_tagged_tuple, {f, 18}, [{x, 0}, 3, {atom, value}]}.
    {get_tuple_element, {x, 0}, 1, {x, 0}}.
    {deallocate, 1}.
    return.
  {label, 18}.
