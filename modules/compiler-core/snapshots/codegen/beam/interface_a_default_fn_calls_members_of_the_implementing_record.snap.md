...
{function, main, 0, 3}.
  ...
  {label, 3}.
    ...
    {move, {y, 1}, {x, 0}}.
    {test, is_map, {f, 8}, [{x, 0}]}.
    {get_map_elements, {f, 8}, {x, 0}, {list, [{atom, cents}, {x, 0}]}}.
  {label, 8}.
    {test_heap, 2, 1}.
...
{function, min, 2, 3}.
  ...
  {label, 3}.
    ...
    {move, {y, 0}, {x, 0}}.
    {test, is_map, {f, 7}, [{x, 0}]}.
    {get_map_elements, {f, 7}, {x, 0}, {list, [{atom, cents}, {x, 0}]}}.
  {label, 7}.
    {move, {x, 0}, {x, 1}}.
    {move, {y, 1}, {x, 0}}.
    {test, is_map, {f, 8}, [{x, 0}]}.
...
{function, max, 2, 5}.
  ...
  {label, 5}.
    ...
    {get_map_elements, {f, 11}, {x, 0}, {list, [{atom, cents}, {x, 0}]}}.
  {label, 11}.
    {move, {x, 0}, {x, 1}}.
    {move, {y, 1}, {x, 0}}.
    {test, is_map, {f, 12}, [{x, 0}]}.
    {get_map_elements, {f, 12}, {x, 0}, {list, [{atom, cents}, {x, 0}]}}.
  {label, 12}.
