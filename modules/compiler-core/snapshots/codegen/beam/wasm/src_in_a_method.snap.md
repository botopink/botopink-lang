...
(module
  ...
  (data (i32.const 256) "\2d\00\00\00R\0eSourceLocation\04\04files\04linei\06columni\06fnNames")
  (data (i32.const 308) "\07\00\00\00main.bp")
  (data (i32.const 320) "\0a\00\00\00Stub.where")
  (data (i32.const 336) "\0a\00\00\00R\04Stub\01\01ni")
  (global $__heap_ptr (mut i32) (i32.const 352))
  (func $Stub_where (param $self i32) (result i32)
    (local $__mem0 i32)
