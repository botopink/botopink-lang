...
----- WASM TEXT -- models/user.wat
```wasm
(module
  (memory (export "memory") 1)
  (data (i32.const 256) "\0b\00\00\00models/user")
  (global $__heap_ptr (mut i32) (i32.const 272))
  (func $label (export "label") (result i32)
    i32.const 256
    return
  )
)
...
----- WASM TEXT -- services/user.wat
```wasm
(module
  (memory (export "memory") 1)
  (data (i32.const 256) "\0d\00\00\00services/user")
  (global $__heap_ptr (mut i32) (i32.const 276))
  (func $tag (export "tag") (result i32)
    i32.const 256
    return
  )
)
...
(module
  ...
  (memory (export "memory") 1)
  (data (i32.const 256) "\0b\00\00\00models/user")
  (data (i32.const 272) "\0d\00\00\00services/user")
