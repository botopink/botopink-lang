...
{function, main, 0, 3}.
  ...
  {label, 3}.
    ...
    {move, {x, 0}, {y, 0}}.
    {move, {y, 0}, {x, 0}}.
    {test, is_tagged_tuple, {f, 9}, [{x, 0}, 2, {atom, 'Shape.Circle'}]}.
  ...
  {label, 8}.
    {test_heap, 4, 0}.
    {put_tuple2, {x, 0}, {list, [{atom, 'Rect'}, {integer, 2}, {integer, 5}]}}.
    {move, {x, 0}, {y, 2}}.
    {move, {y, 2}, {x, 0}}.
    {test, is_tagged_tuple, {f, 24}, [{x, 0}, 2, {atom, 'Shape.Circle'}]}.
    {get_tuple_element, {x, 0}, 1, {x, 1}}.
    {move, {x, 1}, {y, 3}}.
    {test_heap, {alloc, [{words, 1}, {floats, 0}, {funs, 1}]}, 0}.
    {make_fun3, {f, 26}, 0, 0, {x, 0}, {list, [{y, 3}]}}.
    {jump, {f, 23}}.
  {label, 24}.
    {test_heap, {alloc, [{words, 0}, {floats, 0}, {funs, 1}]}, 0}.
...
{function, '-main/0-fun-3-', 0, 28}.
  {label, 27}.
    {line, [{location, "main.erl", 2}]}.
    {func_info, {atom, main}, {atom, '-main/0-fun-3-'}, 0}.
  {label, 28}.
    {allocate, 0, 0}.
    {move, {integer, 0}, {x, 0}}.
    {test_heap, 2, 1}.
