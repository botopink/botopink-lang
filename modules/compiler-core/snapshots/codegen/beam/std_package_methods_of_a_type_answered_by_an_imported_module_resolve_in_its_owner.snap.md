...
{function, main, 0, 3}.
  ...
  {label, 3}.
    ...
    {test, is_map, {f, 8}, [{x, 0}]}.
    {get_map_elements, {f, 8}, {x, 0}, {list, [{atom, insert}, {x, 0}]}}.
  {label, 8}.
    {move, {integer, 1}, {x, 1}}.
    {move, {x, 0}, {x, 2}}.
    {move, {y, 0}, {x, 0}}.
    ...
    {get_map_elements, {f, 11}, {x, 0}, {list, [{atom, lookup}, {x, 0}]}}.
  {label, 11}.
    {move, {x, 1}, {x, 2}}.
    {move, {x, 0}, {x, 1}}.
    {move, {x, 2}, {x, 0}}.
    {call_fun, 1}.
    {test, is_eq, {f, 9}, [{x, 0}, {atom, undefined}]}.
    {move, {integer, 0}, {x, 0}}.
    {jump, {f, 10}}.
  {label, 9}.
  {label, 10}.
    ...
    {get_map_elements, {f, 25}, {x, 0}, {list, [{atom, insert}, {x, 0}]}}.
  {label, 25}.
    {move, {x, 0}, {x, 2}}.
    {move, {x, 1}, {x, 0}}.
    {move, {integer, 2}, {x, 1}}.
    ...
    {get_map_elements, {f, 26}, {x, 0}, {list, [{atom, size}, {x, 0}]}}.
  {label, 26}.
    {call_fun, 0}.
    {test_heap, 2, 1}.
    {put_list, {x, 0}, nil, {x, 0}}.
