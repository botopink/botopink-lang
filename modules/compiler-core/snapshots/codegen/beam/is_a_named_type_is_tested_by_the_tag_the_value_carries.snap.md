...
{function, nameOf, 1, 3}.
  {label, 2}.
    ...
    {func_info, {atom, main}, {atom, nameOf}, 1}.
  {label, 3}.
    {allocate, 3, 1}.
    {init_yregs, {list, [{y, 0}, {y, 1}, {y, 2}]}}.
    {move, {x, 0}, {y, 0}}.
    {move, {y, 0}, {x, 0}}.
    {test, is_tagged_tuple, {f, 11}, [{x, 0}, 3, {atom, main__t__person}]}.
    {move, {literal, <<"person">>}, {x, 0}}.
    {jump, {f, 10}}.
  {label, 11}.
    {test, is_tagged_tuple, {f, 12}, [{x, 0}, 3, {atom, main__t__vec}]}.
...
{function, main, 0, 5}.
  ...
  {label, 5}.
    ...
    {test_heap, 4, 1}.
    {put_tuple2, {x, 0}, {list, [{atom, main__t__vec}, {x, 0}, {integer, 30}]}}.
    {move, {x, 0}, {y, 0}}.
    {move, {y, 0}, {x, 0}}.
    {test, is_tagged_tuple, {f, 13}, [{x, 0}, 3, {atom, main__t__vec}]}.
    {move, {atom, true}, {x, 0}}.
    {jump, {f, 14}}.
  {label, 13}.
    {move, {atom, false}, {x, 0}}.
  {label, 14}.
    ...
    {call, 1, {f, 16}}.
    {move, {y, 0}, {x, 0}}.
    {test, is_tagged_tuple, {f, 40}, [{x, 0}, 3, {atom, main__t__person}]}.
    {move, {atom, true}, {x, 0}}.
    {jump, {f, 41}}.
  {label, 40}.
    {move, {atom, false}, {x, 0}}.
  {label, 41}.
    ...
    {call, 1, {f, 16}}.
    {test_heap, 3, 0}.
    {put_tuple2, {x, 0}, {list, [{atom, main__t__shape__v__circle}, {integer, 4}]}}.
    {move, {x, 0}, {y, 1}}.
    {move, {y, 1}, {x, 0}}.
    {test, is_ne_exact, {f, 44}, [{x, 0}, {atom, main__t__shape__v__dot}]}.
    {test, is_tagged_tuple, {f, 45}, [{x, 0}, 2, {atom, main__t__shape__v__circle}]}.
    {jump, {f, 44}}.
  {label, 45}.
    {jump, {f, 42}}.
  {label, 44}.
  ...
  {label, 43}.
    ...
    {put_list, {x, 0}, nil, {x, 0}}.
    {call, 1, {f, 16}}.
    {move, {atom, main__t__shape__v__dot}, {x, 0}}.
    {move, {x, 0}, {y, 2}}.
    {move, {y, 2}, {x, 0}}.
    {test, is_ne_exact, {f, 48}, [{x, 0}, {atom, main__t__shape__v__dot}]}.
    {test, is_tagged_tuple, {f, 49}, [{x, 0}, 2, {atom, main__t__shape__v__circle}]}.
    {jump, {f, 48}}.
  {label, 49}.
    {jump, {f, 46}}.
  {label, 48}.
...
{function, '__bp_get', 2, 3}.
  {label, 2}.
    {line, [{location, "main__t__vec.erl", 1}]}.
    {func_info, {atom, main__t__vec}, {atom, '__bp_get'}, 2}.
  {label, 3}.
    {test, is_eq_exact, {f, 4}, [{x, 1}, {atom, name}]}.
    {move, {x, 0}, {x, 1}}.
    {move, {integer, 2}, {x, 0}}.
...
{function, '__bp_format', 1, 7}.
  {label, 6}.
    {line, [{location, "main__t__vec.erl", 1}]}.
    {func_info, {atom, main__t__vec}, {atom, '__bp_format'}, 1}.
  {label, 7}.
    {allocate, 2, 1}.
    {init_yregs, {list, [{y, 0}, {y, 1}]}}.
    {move, {x, 0}, {y, 0}}.
...
{function, '__bp_format', 1, 3}.
  ...
  {label, 3}.
    ...
    {move, {x, 0}, {y, 0}}.
    {move, {y, 0}, {x, 0}}.
    {test, is_eq_exact, {f, 4}, [{x, 0}, {atom, main__t__shape__v__dot}]}.
    {test_heap, 4, 1}.
