...
{function, 'Pato_swim', 1, 3}.
  {label, 2}.
    ...
    {func_info, {atom, test@main}, {atom, 'Pato_swim'}, 1}.
  {label, 3}.
    {allocate, 1, 1}.
    {init_yregs, {list, [{y, 0}]}}.
    {move, {x, 0}, {y, 0}}.
    {move, {y, 0}, {x, 0}}.
    {test, is_tagged_tuple, {f, 10}, [{x, 0}, 2, {atom, test@main@@Pato}]}.
...
{function, main, 0, 5}.
  ...
  {label, 5}.
    ...
    {init_yregs, {list, [{y, 0}]}}.
    {test_heap, 3, 0}.
    {put_tuple2, {x, 0}, {list, [{atom, test@main@@Pato}, {integer, 3}]}}.
    {move, {x, 0}, {y, 0}}.
    {move, {y, 0}, {x, 0}}.
    {call, 1, {f, 3}}.
    {test_heap, 2, 1}.
...
----- BEAM ASSEMBLY -- test@main@@Pato.S
```erlang
...
{function, '__bp_get', 2, 3}.
  {label, 2}.
    {line, [{location, "test@main@@Pato.erl", 1}]}.
    {func_info, {atom, test@main@@Pato}, {atom, '__bp_get'}, 2}.
  {label, 3}.
...
{function, '__bp_format', 1, 6}.
  {label, 5}.
    {line, [{location, "test@main@@Pato.erl", 1}]}.
    {func_info, {atom, test@main@@Pato}, {atom, '__bp_format'}, 1}.
  {label, 6}.
    {allocate, 2, 1}.
    {init_yregs, {list, [{y, 0}, {y, 1}]}}.
    {move, {x, 0}, {y, 0}}.
