...
{function, fetch, 0, 3}.
  ...
  {label, 3}.
    ...
    {test_heap, 3, 1}.
    {put_tuple2, {x, 0}, {list, [{atom, main__t__fetcherror}, {x, 0}]}}.
    {move, {x, 0}, {x, 1}}.
    {test_heap, 3, 2}.
...
----- BEAM ASSEMBLY -- main__t__fetcherror.S
```erlang
...
{function, '__bp_get', 2, 3}.
  {label, 2}.
    {line, [{location, "main__t__fetcherror.erl", 1}]}.
    {func_info, {atom, main__t__fetcherror}, {atom, '__bp_get'}, 2}.
  {label, 3}.
...
{function, '__bp_format', 1, 6}.
  {label, 5}.
    {line, [{location, "main__t__fetcherror.erl", 1}]}.
    {func_info, {atom, main__t__fetcherror}, {atom, '__bp_format'}, 1}.
  {label, 6}.
    {allocate, 2, 1}.
    {init_yregs, {list, [{y, 0}, {y, 1}]}}.
    {move, {x, 0}, {y, 0}}.
