...
{function, main, 0, 3}.
  ...
  {label, 3}.
    ...
    {move, {x, 0}, {y, 0}}.
    {test_heap, 4, 0}.
    {put_tuple2, {x, 0}, {list, [{atom, test@main@@P}, {integer, 3}, {integer, 4}]}}.
    {move, {y, 0}, {x, 1}}.
    {test_heap, 2, 2}.
    {put_list, {x, 0}, {x, 1}, {x, 0}}.
    {move, {x, 0}, {y, 0}}.
    {test_heap, 4, 0}.
    {put_tuple2, {x, 0}, {list, [{atom, test@main@@P}, {integer, 1}, {integer, 2}]}}.
    {move, {y, 0}, {x, 1}}.
    {test_heap, 2, 2}.
    {put_list, {x, 0}, {x, 1}, {x, 0}}.
    {move, {x, 0}, {y, 1}}.
...
{function, '__bp_get', 2, 3}.
  {label, 2}.
    {line, [{location, "test@main@@P.erl", 1}]}.
    {func_info, {atom, test@main@@P}, {atom, '__bp_get'}, 2}.
  {label, 3}.
...
{function, '__bp_format', 1, 7}.
  {label, 6}.
    {line, [{location, "test@main@@P.erl", 1}]}.
    {func_info, {atom, test@main@@P}, {atom, '__bp_format'}, 1}.
  {label, 7}.
    {allocate, 2, 1}.
    {init_yregs, {list, [{y, 0}, {y, 1}]}}.
    {move, {x, 0}, {y, 0}}.
    ...
    {put_list, {x, 0}, {y, 1}, {y, 1}}.
    {test_heap, 4, 1}.
    {put_tuple2, {x, 0}, {list, [{atom, record}, {literal, <<"P">>}, {y, 1}]}}.
    {deallocate, 2}.
    return.
```
