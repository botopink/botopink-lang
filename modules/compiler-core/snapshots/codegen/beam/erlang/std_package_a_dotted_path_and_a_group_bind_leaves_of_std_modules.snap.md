...
%% import Dict, gt, reverse, rank

main() ->
    D = std@collections@@Dict:empty(),
    '__bp_print'([std@collections@@Dict:size(std@collections@@Dict:insert(D, <<"a">>, 1))]),
    '__bp_print'([std@collections:toInt(std@collections:reverse(std@collections:gt()))]).
