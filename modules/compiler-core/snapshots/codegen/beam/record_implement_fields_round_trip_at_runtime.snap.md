...
{function, mk, 0, 3}.
  ...
  {label, 3}.
    ...
    {move, {literal, <<"x">>}, {x, 0}}.
    {test_heap, 4, 1}.
    {put_tuple2, {x, 0}, {list, [{atom, test@main@@E}, {x, 0}, {integer, 5}]}}.
    {deallocate, 0}.
    return.
...
{function, main, 0, 5}.
  ...
  {label, 5}.
    {allocate, 0, 0}.
    {call, 0, {f, 3}}.
    {test, is_tagged_tuple, {f, 10}, [{x, 0}, 3, {atom, test@main@@E}]}.
...
{function, '__bp_get', 2, 3}.
  {label, 2}.
    {line, [{location, "test@main@@E.erl", 1}]}.
    {func_info, {atom, test@main@@E}, {atom, '__bp_get'}, 2}.
  {label, 3}.
    {test, is_eq_exact, {f, 4}, [{x, 1}, {atom, tag}]}.
    {move, {x, 0}, {x, 1}}.
    {move, {integer, 2}, {x, 0}}.
    {call_ext_only, 2, {extfunc, erlang, element, 2}}.
  {label, 4}.
    {test, is_eq_exact, {f, 5}, [{x, 1}, {atom, n}]}.
    {move, {x, 0}, {x, 1}}.
    {move, {integer, 3}, {x, 0}}.
    {call_ext_only, 2, {extfunc, erlang, element, 2}}.
  {label, 5}.
...
{function, '__bp_format', 1, 7}.
  {label, 6}.
    {line, [{location, "test@main@@E.erl", 1}]}.
    {func_info, {atom, test@main@@E}, {atom, '__bp_format'}, 1}.
  {label, 7}.
    {allocate, 2, 1}.
    {init_yregs, {list, [{y, 0}, {y, 1}]}}.
    {move, {x, 0}, {y, 0}}.
    ...
    {put_list, {x, 0}, {y, 1}, {y, 1}}.
    {test_heap, 4, 1}.
    {put_tuple2, {x, 0}, {list, [{atom, record}, {literal, <<"E">>}, {y, 1}]}}.
    {deallocate, 2}.
    return.
```
