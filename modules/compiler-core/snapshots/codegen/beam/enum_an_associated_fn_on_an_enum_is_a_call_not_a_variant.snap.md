...
{function, unit, 0, 3}.
  ...
  {label, 3}.
    {allocate, 0, 0}.
    {test_heap, 3, 0}.
    {put_tuple2, {x, 0}, {list, [{atom, main__t__shape__v__square}, {integer, 1}]}}.
    {deallocate, 0}.
    return.
...
{function, area, 1, 5}.
  ...
  {label, 5}.
    ...
    {move, {x, 0}, {y, 0}}.
    {move, {y, 0}, {x, 0}}.
    {test, is_tagged_tuple, {f, 7}, [{x, 0}, 2, {atom, main__t__shape__v__circle}]}.
    ...
    {jump, {f, 6}}.
  {label, 7}.
    {test, is_tagged_tuple, {f, 8}, [{x, 0}, 2, {atom, main__t__shape__v__square}]}.
    {get_tuple_element, {x, 0}, 1, {x, 1}}.
    {move, {x, 1}, {y, 2}}.
...
{function, '__bp_format', 1, 10}.
  {label, 9}.
    {line, [{location, "main__t__shape.erl", 3}]}.
  ...
  {label, 10}.
    ...
    {move, {x, 0}, {y, 0}}.
    {move, {y, 0}, {x, 0}}.
    {test, is_tagged_tuple, {f, 11}, [{x, 0}, 2, {atom, main__t__shape__v__circle}]}.
    {move, nil, {y, 1}}.
    {move, {integer, 2}, {x, 0}}.
    {move, {y, 0}, {x, 1}}.
    {call_ext, 2, {extfunc, erlang, element, 2}}.
  ...
  {label, 11}.
    {move, {y, 0}, {x, 0}}.
    {test, is_tagged_tuple, {f, 12}, [{x, 0}, 2, {atom, main__t__shape__v__square}]}.
    {move, nil, {y, 1}}.
    {move, {integer, 2}, {x, 0}}.
    {move, {y, 0}, {x, 1}}.
    {call_ext, 2, {extfunc, erlang, element, 2}}.
